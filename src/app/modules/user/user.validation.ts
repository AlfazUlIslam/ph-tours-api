...
export const createUserZodSchema = z.object({
    name: z
        ...
        .min(2, {message: "Name has to contain at least 2 characters"})
        .max(50, {message: "Name can contain at max 50 characters"}),
    email: z
    ...
    address: z
        ...
        .max(200, {message: "Address cannot exceed 200 cahracters"})
        .optional()
});
